...
(defsystem "utils-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "Lane2" :depends-on ("_package_Lane2"))
    (:file "_package_Lane2" :depends-on ("_package"))
    (:file "Lane3" :depends-on ("_package_Lane3"))
    (:file "_package_Lane3" :depends-on ("_package"))
