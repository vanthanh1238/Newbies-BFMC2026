...
class Lane2 {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.bool(obj.crosswalk, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.crosswalk = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.crosswalk !== undefined) {
      resolved.crosswalk = msg.crosswalk;
    }
    else {
      resolved.crosswalk = false
    }
